...
(function (global, factory) {
  ...
  function addVerticalNavigation() {
    ...
    for (var i = 0; i < getState().sections.length; i++) {
      ...
      if (typeof tooltip !== "undefined" && tooltip !== "") {
        li +=
          '<div class="' + SECTION_NAV_TOOLTIP + " fp-" + getOptions().navigationPosition + '">' + tooltip + "</div>";
      }
  ...
  var scrollOverflowHandler = {
    ...
    onPanelScroll: (function () {
      ...
      return function (e) {
        ...
        var direction =
          state.touchDirection !== "none" ? state.touchDirection : prevPosition < currentPosition ? "down" : "up";
  ...
  function styleSlides(section) {
    ...
    if (
      startingSlide != null &&
      state.activeSection &&
      (state.activeSection.index() !== 0 || (state.activeSection.index() === 0 && startingSlide.index() !== 0))
    ) {
  ...
  function hasContentBeyondFullPage() {
    return (
      getContainer().scrollHeight < $body.scrollHeight && getOptions().scrollBar && getOptions().scrollBeyondFullpage
    );
  }
  ...
  function hashChangeHandler() {
    if (!state.isScrolling && !getOptions().lockAnchors) {
      ...
      var isFirstScrollMove =
        typeof state.lastScrolledDestiny === "undefined" && typeof slideAnchor === "undefined" && !state.slideMoving;
      ...
      if (getOptions().fitToSection && state.canScroll) {
        ...
        g_scrollId2 = setTimeout(function () {
          var fixedSections = state.sections.filter(function (section) {
            ...
            return (
              Math.round(sectionValues.bottom) === Math.round(getWindowHeight()) || Math.round(sectionValues.top) === 0
            );
  ...
  function isDestinyTheStartingSection() {
    ...
    return (
      !anchor.section ||
      !destinationSection ||
      (typeof destinationSection !== "undefined" && destinationSection.index() === index(getStartingSection()))
    );
  }
